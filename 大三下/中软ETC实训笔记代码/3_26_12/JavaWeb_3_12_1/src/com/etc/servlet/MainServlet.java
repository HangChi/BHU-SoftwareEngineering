...
public class MainServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //调用后台商品列表接口
        //获取连接
        URL url = new URL("http://10.101.57.200:8080/mainServlet?changePageNow="+ URLEncoder.encode(changePageNow,"utf-8"));
        //获取连接
        ...
        request.setAttribute("pageNow",jsonObject.getInt("pageNow"));
        request.setAttribute("pageSize",jsonObject.getInt("pageSize"));
        request.setAttribute("pageCount",jsonObject.getInt("pageCount"));
